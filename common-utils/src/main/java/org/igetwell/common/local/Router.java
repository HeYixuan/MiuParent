...
public class Router {
     ...
     * @return
     */
    public Store<String, String> doRoute(
        ...
        ConcurrentMap<String, Store<String, String>> services = this.compositeCalculation(tempCategories, rules);

        // 第三步：根据需要消费的服务ID和可用服务信息集查找出需要消费的服务信息：{group,version}
        Store<String, String> service = this.selectService(serviceId, services);
     ...
     * @return
     */
    private ConcurrentMap<String, Store<String, String>> compositeCalculation(
     ...
     * @return
     */
    private Store<String, String> selectService(
            String serviceId, ConcurrentMap<String, Store<String, String>> services) {
