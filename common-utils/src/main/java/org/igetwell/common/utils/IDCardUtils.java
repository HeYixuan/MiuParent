...
public class IDCardUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*String idcard18 = "420624199312112227";//18位
        ...
        //System.out.println("15位身份证号年龄为:"+getAgeByIdCard(idcard15));
        System.out.println("18位身份证号年龄为:"+getAgeByIdCard(idcard18));

        if (!isValidatedAllIdcard(idcard18)) {
            System.out.println("身份号码错误");
        }

        if (getAgeByIdCard(idcard18)<18 || getAgeByIdCard(idcard18)>70) {
